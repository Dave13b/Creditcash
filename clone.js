...
document.getElementById("btn").addEventListener("click", function() {
    console.log(document.getElementById("payForElectricity"))

    document.getElementById("payForElectricity").setAttribute("disabled", "true");
    document.getElementById("payForElectricity").style['backgroundColor'] = 'grey';
...
document.getElementById('meter').addEventListener('input', function(event){
    ...
    document.getElementById("payForElectricity").setAttribute("disabled", "false");
    document.getElementById("payForElectricity").style['backgroundColor'] = 'purple';
    document.getElementById("payForElectricity").style.cursor = 'pointer';
    }else if(number.length > 11){
        document.getElementById("payForElectricity").setAttribute("disabled", "true");
        document.getElementById("payForElectricity").style['backgroundColor'] = 'grey';
        document.querySelector(".modal").style.display = "flex";    
